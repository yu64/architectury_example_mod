...
{   
    ...
    public ExampleScreenHandler(int syncId, Inventory playerInventory) 
    {
        this(syncId, playerInventory, new SimpleContainer(1));
    }

    public ExampleScreenHandler(int syncId, Inventory playerInventory, Container inventory) 
    {
        super(ExampleMod.EXAMPLE_SCREEN_HANDLER.get(), syncId);
